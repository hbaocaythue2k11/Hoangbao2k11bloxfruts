...
local Window = Library:CreateWindow({
    Title = "HGB vn Hub",
    Subtitle = "- Arsenal",
    Image = "rbxassetid://72387368234579"
})
...
MiscGroup:AddButton({
    ...
    Callback = function()
        ...
        if ok2 then
            Library:Notify({
                Title = "Discord",
                Description = "https://discord.gg/aaEz6qdm.",
                Duration = 4
            })
        else
...
-- Final startup
updateHighlightsState()
print("HGB hub | Arsenal + Weapon Enhancements loaded. Banana UI active. (Fixed Infinite Ammo auto-refill)")